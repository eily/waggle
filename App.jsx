...
export default function App(){
  ...
  const[celebration,setCelebration]=useState(null); // "saved" | "firstEggs" | "harvest"
  const[celebrationData,setCelebrationData]=useState(null);
  const[milestone,setMilestone]=useState(null); // first eggs milestone overlay
  ...
  const handleEdit=ins=>{
    const hive=hives.find(h=>h.id===ins.hive_id);
    setSelectedHive(hive);setEditingInspection(ins);setScreen("inspect");
  };
